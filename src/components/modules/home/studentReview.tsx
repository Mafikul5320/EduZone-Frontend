...
export function TestimonialsSection() {
  return (
    <section
      ...
      style={{
        background: "linear-gradient(180deg, #f8fafc 0%, #f0fdfa 50%, #eef2ff 100%)",
      }}
    >
      {/* Background decorations */}
      <div className="pointer-events-none absolute inset-0">
        <div
          className="absolute -top-20 -left-20 h-80 w-80 rounded-full blur-[80px]"
          style={{ background: "radial-gradient(circle, rgba(20,184,166,0.3) 0%, transparent 70%)" }}
        />
        <div
          className="absolute -bottom-10 -right-10 h-64 w-64 rounded-full blur-[80px]"
          style={{ background: "radial-gradient(circle, rgba(99,102,241,0.2) 0%, transparent 70%)" }}
        />
        <div
          className="absolute left-1/2 top-1/2 h-96 w-96 -translate-x-1/2 -translate-y-1/2 rounded-full blur-[100px]"
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 z-10">
        ...
        >
          {/* Badge */}
          <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-teal-200 bg-teal-50 px-4 py-2 shadow-sm">
          ...
          <h2
            className="mb-4 text-5xl font-black tracking-tight text-slate-900 sm:text-6xl"
          >
            Real Results,{" "}
          ...
          <p className="mx-auto max-w-xl text-lg leading-relaxed text-slate-500">
            Thousands of students have transformed their learning journey with EduLink. Read what they have to say.
          </p>
        </motion.div>
        ...
        <div className="mb-20 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {testimonials.map((t) => (
            <motion.div
              ...
              className="group relative flex cursor-default flex-col rounded-3xl border border-white/60 bg-white/70 backdrop-blur-xl p-8 shadow-[0_8px_30px_rgba(0,0,0,0.04)] transition-all duration-300 hover:shadow-teal-500/10 hover:shadow-2xl hover:bg-white"
              style={{
            ...
            >
              ...
              <div
                className="absolute inset-x-0 top-0 h-[3px] rounded-t-3xl opacity-0 transition-opacity duration-300 group-hover:opacity-100 bg-gradient-to-r from-teal-400 to-indigo-500"
              />

              {/* Quote mark */}
              <div className="mb-6 flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-teal-50 to-indigo-50 text-teal-500 shadow-sm border border-teal-100/50">
              ...
              {/* Text */}
              <p className="mb-6 flex-1 text-[15px] leading-relaxed text-slate-700 font-medium">"{t.text}"</p>
              ...
              <div className="flex items-center justify-between border-t border-slate-100 pt-5">
                <div className="flex items-center gap-4">
                  <img
                    ...
                    alt={t.name}
                    className="h-10 w-10 rounded-full border-2 border-white shadow-sm bg-slate-50"
                  />
                  <div>
                ...
                <span className="rounded-full bg-indigo-50 px-3 py-1.5 text-[11px] font-bold text-indigo-600 border border-indigo-100 shadow-sm">
                  {t.subject}
                </span>
              </div>
            </motion.div>
        ...
        >
          {stats.map((stat, i) => (
            <motion.div
              ...
              className="group relative overflow-hidden rounded-3xl border border-white/60 bg-white/70 backdrop-blur-xl p-6 text-center shadow-[0_4px_20px_rgba(0,0,0,0.03)] hover:shadow-xl hover:bg-white transition-all duration-300"
            >
              {/* Bottom accent bar */}
              <div
                className="absolute inset-x-0 bottom-0 h-[3px] translate-y-full transition-transform duration-300 group-hover:translate-y-0 bg-gradient-to-r from-teal-400 to-indigo-500"
              />
              <div className="mb-2 text-3xl">{stat.icon}</div>
              <div
                className="mb-1 text-3xl font-black text-slate-900 tracking-tight"
              >
                {stat.value}
              </div>
